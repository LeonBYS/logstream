...
var ChartsWindowActions = function () {
    function ChartsWindowActions() {
        _classCallCheck(this, ChartsWindowActions);

        this.generateActions('getChartsSuccess', 'getChartDataSuccess', 'updateChartData', 'ajaxFail');
    }

    _createClass(ChartsWindowActions, [{
        key: 'getCharts',
        value: function getCharts(project, logname) {
            var _this = this;
            ...
            _api2.default.ajax({
                ...
                _this.getChartsSuccess({ project: project, logname: logname, charts: data });
                for (var i = 0; i < data.length; i++) {
                    _this.getChartData(project, logname, data[i]);
                }
            }, function (jqXhr) {
        ...
        key: 'getChartData',
        value: function getChartData(project, logname, chartname) {
            var _this2 = this;
            ...
            _api2.default.ajax({
                ...
                _this2.getChartDataSuccess({ name: chartname, data: data });
            }, function (jqXhr) {
    ...
    return ChartsWindowActions;
}();

exports.default = _alt2.default.createActions(ChartsWindowActions);

},{"../alt":5,"../api":6}],2:[function(require,module,exports){
'use strict';
...
},{"../alt":5,"../api":6}],3:[function(require,module,exports){
'use strict';
...
},{"../alt":5,"../api":6}],4:[function(require,module,exports){
'use strict';
...
},{"../alt":5,"../api":6}],5:[function(require,module,exports){
'use strict';
...
var _chartsWindowActions = require('../actions/chartsWindowActions.js');

var _chartsWindowActions2 = _interopRequireDefault(_chartsWindowActions);

var _chartsWindowStore = require('../stores/chartsWindowStore.js');

var _chartsWindowStore2 = _interopRequireDefault(_chartsWindowStore);
...
var ChartsWindow = function (_React$Component2) {
    ...
    _createClass(ChartsWindow, [{
        ...
        value: function componentWillUnmount() {
            _chartsWindowStore2.default.unlisten(this.onChange);
        }
    }, {
        key: 'onChange',
...
exports.default = ChartsWindow;

}).call(this,require('_process'))

},{"../actions/chartsWindowActions.js":1,"../stores/chartsWindowStore.js":16,"_process":20,"react":"react","react-chartjs-2":65}],9:[function(require,module,exports){
'use strict';
...
var _chartsWindow = require('./chartsWindow');

var _chartsWindow2 = _interopRequireDefault(_chartsWindow);
...
},{"../actions/contentActions":2,"../stores/contentStore":17,"./chartsWindow":8,"./logWindow":11,"react":"react"}],10:[function(require,module,exports){
'use strict';
...
var _chartsWindowActions = require('../actions/chartsWindowActions');
...
},{"../actions/chartsWindowActions":1,"../actions/logWindowActions":3,"../api":6,"./content":9,"./navBar":12,"react":"react"}],11:[function(require,module,exports){
(function (process){
'use strict';
...
},{"../actions/logWindowActions":3,"../stores/logWindowStore":18,"_process":20,"react":"react"}],12:[function(require,module,exports){
'use strict';
...
},{"./sideBar":13,"react":"react"}],13:[function(require,module,exports){
'use strict';
...
},{"../actions/contentActions":2,"../actions/sideBarActions":4,"../stores/sideBarStore":19,"react":"react"}],14:[function(require,module,exports){
'use strict';
...
},{"./components/app":7,"./components/home":10,"react":"react","react-router":"react-router"}],16:[function(require,module,exports){
'use strict';
...
var ChartsWindowStore = function () {
    function ChartsWindowStore() {
        _classCallCheck(this, ChartsWindowStore);

        this.bindActions(_chartsWindowActions2.default);
        this.chartsData = {};
        this.charts = [];
        this.project = null;
        this.logname = null;
    ...
    _createClass(ChartsWindowStore, [{
        key: 'getChartData',
        value: function getChartData(chartname) {
            return this.chartsData[chartname];
        }
    }, {
        key: 'onGetChartsSuccess',
        ...
        key: 'onGetChartDataSuccess',
        value: function onGetChartDataSuccess(chartData) {
            this.chartsData[chartData.name] = chartData.data;
        }
    }, {
        key: 'onUpdateChartData',
        value: function onUpdateChartData(data) {
    ...
    return ChartsWindowStore;
}();

exports.default = _alt2.default.createStore(ChartsWindowStore);

},{"../actions/chartsWindowActions.js":1,"../alt":5}],17:[function(require,module,exports){
'use strict';
...
},{"../actions/contentActions.js":2,"../alt":5}],18:[function(require,module,exports){
'use strict';
...
},{"../actions/logWindowActions":3,"../alt":5}],19:[function(require,module,exports){
'use strict';
...
},{"../actions/sideBarActions":4,"../alt":5}],20:[function(require,module,exports){
...
},{"chartjs-color-string":22,"color-convert":25}],22:[function(require,module,exports){
/* MIT license */
...
},{"color-name":23}],23:[function(require,module,exports){
module.exports = {
...
},{"./charts/Chart.Bar":28,"./charts/Chart.Bubble":29,"./charts/Chart.Doughnut":30,"./charts/Chart.Line":31,"./charts/Chart.PolarArea":32,"./charts/Chart.Radar":33,"./charts/Chart.Scatter":34,"./controllers/controller.bar":35,"./controllers/controller.bubble":36,"./controllers/controller.doughnut":37,"./controllers/controller.line":38,"./controllers/controller.polarArea":39,"./controllers/controller.radar":40,"./core/core.animation":41,"./core/core.canvasHelpers":42,"./core/core.controller":43,"./core/core.datasetController":44,"./core/core.element":45,"./core/core.helpers":46,"./core/core.js":47,"./core/core.layoutService":48,"./core/core.legend":49,"./core/core.plugin.js":50,"./core/core.scale":51,"./core/core.scaleService":52,"./core/core.title":53,"./core/core.tooltip":54,"./elements/element.arc":55,"./elements/element.line":56,"./elements/element.point":57,"./elements/element.rectangle":58,"./scales/scale.category":59,"./scales/scale.linear":60,"./scales/scale.linearbase.js":61,"./scales/scale.logarithmic":62,"./scales/scale.radialLinear":63,"./scales/scale.time":64}],28:[function(require,module,exports){
"use strict";
...
},{"chartjs-color":21}],47:[function(require,module,exports){
"use strict";
...
},{"moment":26}],65:[function(require,module,exports){
'use strict';
...
},{"./utils/deepEqual":66,"chart.js":27,"react":"react","react-dom":"react-dom"}],66:[function(require,module,exports){
'use strict';
